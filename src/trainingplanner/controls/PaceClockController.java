...
public class PaceClockController extends AnchorPane implements Initializable {
    ...
    private void setNumbers() {
        ...
        kids.clear();
        kids.add(creatDigitalNumber(0.5,0.5,0.0,Integer.valueOf(String.valueOf(ints[0]))));
        kids.add(creatDigitalNumber(0.5,0.5,30.0,Integer.valueOf(String.valueOf(ints[1]))));
        kids.add(creatDigitalNumber(0.5,0.5,65.0,Integer.valueOf(String.valueOf(ints[2]))));
        kids.add(creatDigitalNumber(0.5,0.5,95.0,Integer.valueOf(String.valueOf(ints[3]))));
