...
public class IWorkoutType {
    ...
    protected List<IWorkoutType.Excersize> excersize;
     ...
     * {@link IWorkoutType.Excersize }
     * 
     * 
     */
    public List<IWorkoutType.Excersize> getExcersize() {
        if (excersize == null) {
            excersize = new ArrayList<IWorkoutType.Excersize>();
        }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class Excersize
        extends ExcersizeType
    {
